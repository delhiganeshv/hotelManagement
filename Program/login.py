...
class LoginWindow:
    def __init__(self,root):
        ...
        img1=Image.open(r"F:\Projects\hotelManagement\Images\LoginIconApp.png")    #type:ignore
        ...
        #label
        #icon image
        img2=Image.open(r"F:\Projects\hotelManagement\Images\LoginIconApp.png")    #type:ignore
        ...
        usernameEntry=ttk.Entry(frame,textvariable=self.username,font=('times new roman',15,'bold'),width=25)
        usernameEntry.place(x=20,y=190)
        
        #icon image
        img3=Image.open(r"F:\Projects\hotelManagement\Images\Lock-512.png")    #type:ignore
        ...
        passwordEntry=ttk.Entry(frame,textvariable=self.password,font=('times new roman',15,'bold'),width=25)
        passwordEntry.place(x=20,y=260)
        
        #login button
        loginBtn=Button(frame,command=self.login,text='Login',font=('times new roman',15,'bold'),bd=3,relief=RIDGE,cursor='hand2',bg='red',fg='white',activeforeground='white',activebackground='green')
        loginBtn.place(x=20,y=320,width=260,height=35)
                
        #register button
        registerBtn=Button(frame,text='New User? Register',font=('times new roman',15,'bold'),bd=0,cursor='hand2',bg='black',fg='white',activeforeground='green',activebackground='black')
        registerBtn.place(x=20,y=400,width=260,height=35)
        
        #forget password button
        forgetBtn=Button(frame,text='Forget Password ?',font=('times new roman',15,'bold'),bd=0,cursor='hand2',bg='black',fg='white',activeforeground='green',activebackground='black')
    ...
    def login(self):
        if self.username.get()=="" or self.password.get()=="":
            ...
            messagebox.showinfo("Welcome",f"Welcome {self.username.get()}\nYour Password:{self.password.get()}",parent=self.root)
