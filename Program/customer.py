...
class CustomerWindow:
    def __init__(self, root):
        ...
        phoneNumberEntry = Entry(
            labelFrameLeft,
            textvariable=self.mobileNumber,
            width=25,
            font=("times new roman", 13, "bold"),
        )
        ...
        self.customerDetail = ttk.Treeview(
            detailTable,
            column=(
                "ref",
                "name",
    ...
    def addData(self):
        if (
            self.name.get() == ""
            or self.address.get() == ""
            or self.mobileNumber.get() == ""
            or self.email.get() == ""
            or self.gender.get() == ""
            or self.nationality.get() == ""
            or self.id.get() == ""
            or self.idNumber.get() == ""
            or self.postcode.get() == ""
        ):
    ...
    def update(self):
        if (
            ...
            try:
                ...
                messagebox.showinfo(
                    "Success", "Customer Detail has been updated", parent=self.root
                )
                self.displayAll()
                self.reset()
            except Exception as es:
        ...
        if self.ref.get() == "":
            ...
            try:
                ...
                if ask > 0:
                    ...
                    messagebox.showinfo(
                        "Success", "Customer Detail has been deleted", parent=self.root
                    )
                    self.displayAll()
            except Exception as es:
                messagebox.showerror(
